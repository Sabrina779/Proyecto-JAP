...
document.addEventListener("DOMContentLoaded", function(e) {
    ...
    getJSONData(CART_PRODUCTS).then(function(resultObj) {
        if (resultObj.status === "ok") {
            ...
            document.getElementById("buttonTitle").innerHTML = "Seleccionar tipo de envío"
        }
    ...
    document.getElementById("envioMdv").onclick = function(e) {
        subtotalEnPantalla = true;
        porcentaje = 1, 5
        calcularCostoDeEnvio(porcentaje)
        document.getElementById("buttonTitle").innerHTML = "Envío dentro de Montevideo"
    }
    document.getElementById("envioInterior").onclick = function(e) {
        porcentaje = 2
        subtotalEnPantalla = true;
        calcularCostoDeEnvio(porcentaje)
        document.getElementById("buttonTitle").innerHTML = "Envío al interior"
    }
    document.getElementById("envioSucursal").onclick = function(e) {
        subtotalEnPantalla = true;
        porcentaje = 0
        calcularCostoDeEnvio(porcentaje)
        document.getElementById("buttonTitle").innerHTML = "Retiro en sucursal"
    }
